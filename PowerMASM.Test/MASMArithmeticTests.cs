...
public class MASMArithmeticTests
{
    ...
    {
        var state = new MicroAsmVmState();
        mov.Call(state, "RAX", 20);
        mov.Call(state, "RBX", 4);
        var divFunc = new div();
    ...
    {
        var state = new MicroAsmVmState();
        mov.Call(state, "RAX", 0b1101);
        mov.Call(state, "RBX", 0b1011);
        var andFunc = new and();
